...
We validate this definition by applying it to the minimal quantum phase space (a de Gosson blob), which is bounded by a minimum action of $h/2$. If this fundamental space is saturated by one position bit and one momentum bit ($K=2$), the minimal erasure action is:
...
\subsection{Erasure Action and Classical Action}
