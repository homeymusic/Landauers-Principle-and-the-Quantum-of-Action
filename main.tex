...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth]{figures/partitioning_grid.png}
\caption{\textbf{Position densities for the harmonic oscillator}.}
\label{fig:partitioning_grid}
\end{figure}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/partitioning_path.png}
\caption{\textbf{Kinematic partitioning and thermodynamic erasure} (schematic).}
\label{fig:partitioning_path}
\end{figure}
...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/partitioning_tree.png}
\caption{\textbf{Kinematic partitioning and thermodynamic erasure tree} (schematic).}
\label{fig:partitioning_tree}
\end{figure*}
